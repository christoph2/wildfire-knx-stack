...
typedef struct tagKnxMsg_StandardFrameType {
    uint8_t   ctrl;
    uint8_t   source[2];
    uint8_t   dest[2];
    uint8_t   npci;
...
} KnxMsg_StandardFrameType, * KnxMsg_StandardFrameRefType;    /* KnxMsg_StandardFrameType */

typedef struct tagKnxMsg_PropertyFrameType {
    uint8_t   ctrl;
    uint8_t   source[2];
    uint8_t   dest[2];
    uint8_t   npci;
...
} KnxMsg_PropertyFrameType, * KnxMsg_PropertyFrameRefType;    /* KnxMsg_PropertyFrameType */

typedef struct tagKnxMsg_PollingFrameType {
    uint8_t   ctrl;
    uint8_t   source[2];
    uint8_t   poll_addr[2];
    uint8_t   num_slots;
    uint8_t   slot[MAX_ADPU_LEN];
} KnxMsg_PollingFrameType, * KnxMsg_PollingFrameRefType;  /* KnxMsg_PollingFrameType */
