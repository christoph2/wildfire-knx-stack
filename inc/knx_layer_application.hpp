...
*
*/
#if !defined(__KNX_LAYER_APPLICATION_HPP)
#define __KNX_LAYER_APPLICATION_HPP
...
FUNC(void, KSTACK_CODE) DEV_SetVerifyMode(bool on);
FUNC(void, KSTACK_CODE) DEV_ChkOwnPhysAddrRcvd(bool on);
...
#endif  /* __KNX_LAYER_APPLICATION_HPP */
