...
#define KnxMsg_GetQueueForService(service) ((uint8_t)KnxMsg_MessageRedirectionTable[static_cast<uint8_t>(service) >> 4])
...
//    Dbg_TraceFunctionEntry(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_ALLOCATE_BUFFER);
    ...
    KNX_ASSERT_MODULE_IS_INITIALIZED_RETURN(MSG, AR_SERVICE_MSG_ALLOCATE_BUFFER, Knx_StatusType::KNX_E_NOT_OK);
    if (buffer == NULL) {
...
//        Dbg_TraceFunctionExit(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_ALLOCATE_BUFFER);
        return Knx_StatusType::KNX_E_NOT_OK;
    }
...
//        Dbg_TraceFunctionExit(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_ALLOCATE_BUFFER);
        return Knx_StatusType::KNX_E_NOT_OK;       /* No buffer available. */
    }
...
//    Dbg_TraceFunctionExit(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_ALLOCATE_BUFFER);
    return Knx_StatusType::KNX_E_OK;
}
...
#endif
{
    ...
    if (KnxMsg_AllocateBuffer(&buffer) == Knx_StatusType::KNX_E_OK) {
...
//    Dbg_TraceFunctionEntry(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_RELEASE_BUFFER);
    ...
    KNX_ASSERT_MODULE_IS_INITIALIZED_RETURN(MSG, AR_SERVICE_MSG_RELEASE_BUFFER, Knx_StatusType::KNX_E_NOT_OK);
    if (ptr == NULL) {
...
//            Dbg_TraceFunctionExit(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_RELEASE_BUFFER);
            return Knx_StatusType::KNX_E_NOT_OK;   /* Not allocated. */
        }
...
//    Dbg_TraceFunctionEntry(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_CLEAR_BUFFER);
    ...
    KNX_ASSERT_MODULE_IS_INITIALIZED_RETURN(MSG, AR_SERVICE_MSG_CLEAR_BUFFER, Knx_StatusType::KNX_E_NOT_OK);
    if (ptr == NULL) {
...
//    Dbg_TraceFunctionEntry(KNX_MODULE_ID_MSG, AR_SERVICE_MSG_POST);
    ...
    KNX_ASSERT_MODULE_IS_INITIALIZED_RETURN(MSG, AR_SERVICE_MSG_POST, Knx_StatusType::KNX_E_NOT_OK);
...
/*
   bool MSG_GetRoutingCtrl(const PMSG_Buffer pBuffer)
   {
