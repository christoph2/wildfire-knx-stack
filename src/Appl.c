...
IMPLEMENT_COMMOBJ(0, (KNX_OBJ_COMM_ENABLE | KNX_OBJ_TRANSMIT_ENABLE | KNX_OBJ_WRITE_ENABLE | KNX_OBJ_PRIO_LOW), KNX_OT_UINT16)
IMPLEMENT_COMMOBJ(2, (KNX_OBJ_COMM_ENABLE | KNX_OBJ_TRANSMIT_ENABLE), KNX_OT_FLOAT)
IMPLEMENT_COMMOBJ(6, (KNX_OBJ_COMM_ENABLE | KNX_OBJ_TRANSMIT_ENABLE), KNX_OT_UINT1)
END_COMMOBJ_TABLE()
